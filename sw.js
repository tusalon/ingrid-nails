// sw.js - Service Worker para Ingrid Nails

const CACHE_NAME = 'ingrid-nails-v1';
const urlsToCache = [
  '/ingrid-nails/',
  '/ingrid-nails/index.html',
  '/ingrid-nails/admin.html',
  '/ingrid-nails/admin-login.html',
  '/ingrid-nails/setup-wizard.html',
  '/ingrid-nails/editar-negocio.html',
  '/ingrid-nails/manifest.json',
  '/ingrid-nails/icons/icon-72x72.png',
  '/ingrid-nails/icons/icon-96x96.png',
  '/ingrid-nails/icons/icon-128x128.png',
  '/ingrid-nails/icons/icon-144x144.png',
  '/ingrid-nails/icons/icon-152x152.png',
  '/ingrid-nails/icons/icon-192x192.png',
  '/ingrid-nails/icons/icon-384x384.png',
  '/ingrid-nails/icons/icon-512x512.png'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/ingrid-nails/icons/icon-192x192.png');
          }
...
console.log('✅ Service Worker configurado para Ingrid Nails');
